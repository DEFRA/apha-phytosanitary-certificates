...
namespace PhytosanitaryCertificates
{
    public class WorkflowRunnerService
    {
        ...
        /// </summary>
        public System.Data.DataTable Review_ADs(string in_strCountryOfOrigin, string in_strSec11AD, System.Data.DataTable io_dtCommodityLines)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\AD\Review ADs.xaml", new Dictionary<string, object>{{"in_strCountryOfOrigin", in_strCountryOfOrigin}, {"in_strSec11AD", in_strSec11AD}, {"io_dtCommodityLines", io_dtCommodityLines}}, default, default, default, GetAssemblyName());
            return (System.Data.DataTable)result["io_dtCommodityLines"];
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public System.Data.DataTable Review_ADs(string in_strCountryOfOrigin, string in_strSec11AD, System.Data.DataTable io_dtCommodityLines, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"Process\Process Subflows\AD\Review ADs.xaml", new Dictionary<string, object>{{"in_strCountryOfOrigin", in_strCountryOfOrigin}, {"in_strSec11AD", in_strSec11AD}, {"io_dtCommodityLines", io_dtCommodityLines}}, default, isolated, default, GetAssemblyName());
            return (System.Data.DataTable)result["io_dtCommodityLines"];
        }
