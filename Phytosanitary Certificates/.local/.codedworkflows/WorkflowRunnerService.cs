...
namespace PhytosanitaryCertificates
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the test-del.xaml
        /// </summary>
        public void test_del()
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"test-del.xaml", new Dictionary<string, object>{}, default, default, default, GetAssemblyName());
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public void test_del(System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"test-del.xaml", new Dictionary<string, object>{}, default, isolated, default, GetAssemblyName());
        }
