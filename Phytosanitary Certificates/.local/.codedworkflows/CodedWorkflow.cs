...
namespace PhytosanitaryCertificates
{
    ...
    {
        private Lazy<global::PhytosanitaryCertificates.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::PhytosanitaryCertificates.WorkflowRunnerService>(() => new global::PhytosanitaryCertificates.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::PhytosanitaryCertificates.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
